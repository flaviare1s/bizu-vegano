export const ReceitaTapioca = () => {
  return (
    <section className="flex flex-col m-auto bg-branco-quente text-verde-escuro w-full sm:max-w-[450px] md:max-w[600px] lg:max-w-[800px] rounded p-5">
      ...
      <h4>Preparo:</h4>
      <p>Misture a farinha de milho flocada com o sal e a água e deixe hidratando por 10 minutos.</p>
      <p>Adicione a goma de tapioca e os temperos e misture bem.</p>
      <p>Unte uma frigideira com azeite e disponha a massa. Deixe durante 4 minutos de cada lado.</p>
      <h4>Dicas:</h4>
      <p>
      ...
      <p>Também gosto de fazer ela bem crocante e comer com pastinhas de castanha e legumes.</p>
      <h4>Legumes assados:</h4>
      <p>
      ...
      <p>Simples, rápido e delicioso!</p>
    </section>
  )
}
