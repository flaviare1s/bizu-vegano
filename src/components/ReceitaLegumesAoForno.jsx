  ...
  return (
    <section className="flex flex-col m-auto bg-branco-quente text-verde-escuro w-full sm:max-w-[450px] md:max-w[600px] lg:max-w-[800px] rounded p-5">
      ...
      <ul className="list-disc list-inside mt-2">
        ...
        <li>1 berinjela picada</li>
        <li>1 pimentão vermelho em tirinhas</li>
        <li>4 tomates cortados em pedaços grandes</li>
        <li>Pimentas picadas a gosto</li>
        <li>Azeitonas</li>
        <li>Alcaparras</li>
        <li>Sal, pimenta do reino, noz-moscada, orégano e manjericão</li>
        <li>Azeite</li>
      </ul>
...
// export const  = () => {
//   return (
//     <section className="lojas p-4 bg-white text-gray-800 rounded shadow-md">
