...
export const Home = () => {
  return (
    <main className='flex flex-col justify-center items-center gap-1 m-auto mb-3'>
      <Link to='/restaurantes' className='w-full border border-branco-quente rounded relative'>
        ...
        <h2 className='text-center text-3xl font-semibold text-branco-quente absolute bottom-[10px] right-[20px]'>Restaurantes</h2>
      </Link>
      <Link to='/lanchonetes' className='w-full border border-branco-quente rounded relative'>
        ...
        <h2 className='text-center text-3xl font-semibold text-branco-quente absolute bottom-[10px] right-[20px]'>Lanchonetes</h2>
      </Link>
      <Link to='/confeitarias' className='w-full border border-branco-quente rounded relative'>
        <img className='h-[200px] w-full object-cover rounded' src={ confeitarias } alt="Imagem de comida vegetariana" />
        <h2 className='text-center text-3xl font-semibold text-branco-quente absolute bottom-[10px] right-[20px]'>Confeitarias</h2>
      </Link>
      <Link to='/emporios' className='w-full border border-branco-quente rounded relative'>
        ...
        <h2 className='text-center text-3xl font-semibold text-branco-quente absolute bottom-[10px] right-[20px]'>Empórios</h2>
      </Link>
      <Link to='/queijarias' className='w-full border border-branco-quente rounded relative'>
        ...
        <h2 className='text-center text-3xl font-semibold text-branco-quente absolute bottom-[10px] right-[20px]'>Queijarias</h2>
      </Link>
      <Link to='/festas' className='w-full border border-branco-quente rounded relative'>
        ...
        <h2 className='text-center text-3xl font-semibold text-branco-quente absolute bottom-[10px] right-[20px]'>Festas</h2>
      </Link>
      <Link to='/sorvetes' className='w-full border border-branco-quente rounded relative'>
        ...
        <h2 className='text-center text-3xl font-semibold text-branco-quente absolute bottom-[10px] right-[20px]'>Sorvetes</h2>
      </Link>
      <Link to='/cafes' className='w-full border border-branco-quente rounded relative'>
        ...
        <h2 className='text-center text-3xl font-semibold text-branco-quente absolute bottom-[10px] right-[20px]'>Cafés</h2>
      </Link>
      <Link to='/onde-comer' className='w-full border border-branco-quente rounded relative'>
        <img className='h-[200px] w-full object-cover rounded' src={ ondeComer } alt="Imagem de comida vegetariana" />
        <h2 className='text-center text-3xl font-semibold text-branco-quente absolute bottom-[10px] right-[20px]'>Onde Comer</h2>
      </Link>
      <Link to='/cosmeticos' className='w-full border border-branco-quente rounded relative'>
        ...
        <h2 className='text-center text-3xl font-semibold text-branco-quente absolute bottom-[10px] right-[20px]'>Cosméticos</h2>
      </Link>
      <Link to='/dicas' className='w-full border border-branco-quente rounded relative'>
        ...
        <h2 className='text-center text-3xl font-semibold text-branco-quente absolute bottom-[10px] right-[20px]'>Dicas</h2>
      </Link>
      <Link to='/canais-youtube' className='w-full border border-branco-quente rounded relative'>
