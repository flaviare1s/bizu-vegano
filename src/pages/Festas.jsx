    ...
    <section className='flex flex-col justify-center items-center my-3'>
      ...
      {loading ? (
        ...
        <article className='sm:grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 md:px-[30px] lg:px-[100px]'>
          {festas.map(festa => (
            <div key={festa.id} className='bg-branco-quente border border-marrom-claro rounded p-4 m-4'>
              ...
              <a className='flex items-center gap-2 mt-2' href={festa.url}>Instagram <i className="fa-brands fa-instagram text-2xl"></i></a>
            </div>
          ))}
        </article>
      )}
