...
export const Restaurantes = () => {
  ...
  return (
    <section className='flex flex-col justify-center items-center my-6 px-4'>
      <h1 className='text-3xl md:text-5xl uppercase text-branco-quente font-bold my-4 md:my-6'>Restaurantes</h1>
      {loading ? (
        <Loader />
      ) : (
              ...
              <div className='p-6 flex-grow'>
                ...
                {restaurante.endereco && (
                  <div className='flex items-start gap-2 text-xs text-gray-500 bg-gray-50 rounded-lg p-3'>
                    ...
                    <span className='font-medium'>{restaurante.endereco}</span>
                  </div>
                )}
              </div>
