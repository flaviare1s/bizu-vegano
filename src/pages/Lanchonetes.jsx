...
export const Lanchonetes = () => {
  ...
  return (
    <section className='flex flex-col justify-center items-center my-3'>
      <h1 className='text-2xl md:text-5xl uppercase text-branco-quente font-bold'>lanchonetes</h1>
        ...
        {lanchonetes.map(lanchonete => (
          <div className='bg-branco-quente border border-marrom-claro rounded p-4 m-4'>
            <div className='flex justify-start items-center gap-5'>
              ...
              <a href={lanchonete.url} className='uppercase font-bold mb-2 text-center' key={lanchonete.id}>{lanchonete.nome}</a>
            </div>
            <hr />
