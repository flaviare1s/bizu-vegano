export const Sobre = () => {
  return (
    <main className='w-[90%] md:max-w-4xl mx-auto px-4 py-8 bg-branco-quente my-2 rounded'>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-bold mb-4'>Diferença entre Veganismo e Vegetarianismo</h2>
        <p>
