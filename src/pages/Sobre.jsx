  ...
  return (
    <main className='w-[90%] md:max-w-4xl mx-auto px-8 py-10 bg-white my-8 rounded-2xl shadow-lg'>
      <section className='mb-8'>
        <h1 className='text-3xl md:text-4xl font-bold mb-6 text-verde-escuro'>Sobre Bizu Vegano</h1>
      ...
      <section className='mb-8'>
        <h2 className='text-2xl md:text-3xl font-bold mb-6 text-verde-escuro'>Diferença entre Veganismo e Vegetarianismo</h2>
        <p className='mb-4 text-gray-700 leading-relaxed'>
